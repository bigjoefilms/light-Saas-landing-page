    ...
    <section className="py-24 bg-white ">
      <div className="container">
        ...
        <p className="section-description mt-5 ">
          Free forever, Upgrade for unlimited task, better security, and exclusive features.
        </p>
        </div>
          ...
          {pricingTiers.map(({ 
            ...
            <div key={index} className={twMerge( 'card', inverse === true && 'border-black bg-black text-white')}>
              ...
              {popular === true && (
                 ...
                 className=' text-transparent bg-clip-text bg-[linear-gradient(to_right,#DD7DDF,#E1CD86,#BBCB92,#71C2EF,#3BFFFF,#DD7DDF,#E1CD86,#BBCB92,#71C2EF,#3BFFFF)] [background-size:200%]' >Popular</motion.span></div>
